...
public class SplashKud implements Initializable {
    ...
    public void beharDirenFileSortu() throws IOException {
        ...
        if (System.getProperty("os.name").toLowerCase().contains("win")) {
            Runtime.getRuntime().exec("wsl wget https://raw.githubusercontent.com/Jasielprogramador/base_de_datos/master/whatweb.sqlite -O "+System.getProperty("user.home")+File.separator+".whatwebfx/whatweb.sqlite");
        } else {
            Runtime.getRuntime().exec("wget https://raw.githubusercontent.com/Jasielprogramador/base_de_datos/master/whatweb.sqlite -O "+System.getProperty("user.home")+File.separator+".whatwebfx"+File.separator+"whatweb.sqlite");
        }
    }
